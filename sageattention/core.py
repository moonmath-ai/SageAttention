...
def sageattn(
    ...
    **kwargs: Any,
    ...
    """
    return sageattn_qk_int8_pv_fp16_triton(q, k, v, tensor_layout=tensor_layout, is_causal=is_causal, sm_scale=sm_scale, return_lse=return_lse, t=t)
...
def sageattn_qk_int8_pv_fp16_triton(
    ...
    **kwargs: Any,
    ...
    if is_causal:
        ...
        o, lse = attn_false(q_int8, k_int8, v, q_scale, k_scale, tensor_layout=tensor_layout, output_dtype=dtype, return_lse=return_lse, t=t)
